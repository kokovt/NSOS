...
//? For now, this has a problem of returning 1920x1080 instead of the actual
// resolution on larger monitors. ? This will be fixed when I get to it.
...
int init_framebuffer() {
  ...
  if (mailbox_read(MBOX_CH_PROP) && fb_mailbox[20] == 32 &&
      fb_mailbox[28] != 0) {
